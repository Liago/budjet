...
export class TransactionsController {
  ...
  @ApiResponse({ status: 200, description: 'Returns transactions with pagination' })
  ...
  @Delete('all')
  @ApiOperation({ summary: 'Delete all transactions for the authenticated user' })
  @ApiResponse({ status: 200, description: 'All transactions deleted successfully' })
  ...
  @ApiResponse({ status: 201, description: 'Transactions successfully imported' })
  @UseInterceptors(
