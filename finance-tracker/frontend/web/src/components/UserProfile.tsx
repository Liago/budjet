        ...
        <div className="flex items-center p-4 hover:bg-gray-50 rounded-lg transition-all duration-200">
          ...
          <div className="flex flex-col gap-2">
            ...
            <button
              ...
              className="px-3 py-1 text-xs font-medium text-purple-600 hover:text-purple-700 bg-purple-50 hover:bg-purple-100 rounded-full transition-colors duration-200 flex items-center gap-1"
            >
              <svg
                className="w-3 h-3"
                fill="none"
