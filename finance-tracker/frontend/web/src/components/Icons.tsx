...
export const ChartLineIcon: React.FC<IconProps> = ({ className = 'h-6 w-6' }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
// Export Lucide React icons with consistent interface
export {
  Home,
  CreditCard,
  Tag,
...
export const getIconByName = (name: string): React.FC<LucideIconProps> => {
  return (CategoryIcons as Record<string, React.FC<LucideIconProps>>)[name] || ShoppingCart;
}; 